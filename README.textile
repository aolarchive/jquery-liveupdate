...
The element you instantiate @$.liveBlogLiteUI@ on (here, @<div id="#myLiveBlog"></div>@) *can* have content. That content will be displayed until there are actually updates on the live blog post in question *and* the begin time has passed, if that option has been set. This allows you to have pre-event content. Once the initial conditions have been met, the element in question is emptied and refilled with live blog content.
