...
* "Intro":#intro
* "How to use Live Blog Lite":#howtouseit
* "Blogsmith Setup":#blogsmithsetup
* "@$.liveBlogLiteUi;@":#ui
* "@$.liveBlogLiteApi;@":#api

h2(#intro). Two light-weight plugins for publishing Blogsmith liveblog content
...
h2(#howtouseit). How to use Live Blog Lite
...
h2(#blogsmithsetup). Blogsmith Setup
...
h2(#api). $.liveBlogLiteApi(options)
